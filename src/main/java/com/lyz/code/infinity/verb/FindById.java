...
public class FindById extends Verb{
	...
	public Method generateDaoImplMethod(){
		try {
			...
			method.setStandardName("find"+this.domain.getStandardName()+"By"+StringUtil.capFirst(this.domain.getStandardName())+"Id");
			...
			list.add(NamedStatementListGenerator.generateFindByIdStatementList(2000L,3,this.domain));
	...
	public Method generateControllerMethod() {
		...
		wlist.add(NamedStatementGenerator.getSetDomainIdFromRequest(3000L, 3, this.domain, InterVarUtil.Servlet.request));
		wlist.add(new Statement(4000L,3,service.generateTypeVarString() + " = new " + service.getVarType().getTypeName()+"Impl();"));
		wlist.add(new Statement(5000L,3, this.domain.generateTypeVarString() + " = " + service.getVarName()+"."+serviceMethod.generateStandardCallString()+";"));
		wlist.add(new Statement(6000L,3,InterVarUtil.Servlet.request.getVarName()+".setAttribute(\""+StringUtil.lowerFirst(this.domain.getStandardName())+"\","+StringUtil.lowerFirst(domain.getStandardName())+");"));
	...
	public FindById(){
		super();
		if (this.domain != null) this.setVerbName("Find"+this.domain.getStandardName()+"By"+StringUtil.capFirst(this.domain.getStandardName()+"Id"));
	...
	public FindById(Domain domain){
		super();
		this.domain = domain;
		this.setVerbName("Find"+this.domain.getStandardName()+"By"+StringUtil.capFirst(this.domain.getStandardName()+"Id"));
	}
	...
	public Method generateFacadeMethod() {
		...
		wlist.add(new Statement(6000L,3,service.generateTypeVarString() + " = new " + service.getVarType().getTypeName()+"Impl();"));
		wlist.add(new Statement(7000L,3, domainVar.generateTypeVarString() + " = " + service.getVarName()+"."+serviceMethod.generateStandardCallString()+";"));
