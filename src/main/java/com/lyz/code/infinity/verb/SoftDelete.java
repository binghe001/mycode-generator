...
public class SoftDelete extends Verb{
	...
	public Method generateDaoImplMethod() {
		...
		list.add(NamedStatementGenerator.getSoftDeleteSqlStatement(1000L,2, this.domain,InterVarUtil.DB.query));
	...
	public Method generateControllerMethod() {
		...
		wlist.add(NamedStatementListGenerator.generateCatchExceptionPrintStackRedirectUrlFinallyCloseOutFooter(9000L, 2, InterVarUtil.Servlet.response,"../controller/listAll"+this.domain.getPlural()+"Controller", InterVarUtil.Servlet.out));
