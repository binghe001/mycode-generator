...
public class FindById extends Verb{
	...
	public Method generateDaoImplMethod(){
		try {
			...
			list.add(new Statement(3000L,2,"criteria.add(Restrictions.eq(\""+this.domain.getDomainId().getLowerFirstFieldName()+"\","+this.domain.getDomainId().getLowerFirstFieldName()+"));"));
