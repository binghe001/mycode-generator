...
public class JspHomePage extends Include{
	protected String headTitile = "Home Page";
	protected String pageTitile = "Welcome to the JSP Interface.";
	public JspHomePage(){
		super();
	...
	public JspHomePage(String headTitile, String pageTitile){
		super();
		this.fileName = "index.jsp";
		this.packageToken = "";
	...
	public String generateIncludeString() {
        ...
        sb.append("<%} else { %>\n");
        sb.append("<jsp:include page=\"../include/usernav.jsp\"/>\n");
        sb.append("<%} %>\n");
