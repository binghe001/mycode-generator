...
public class Delete extends Verb{
	...
	public Method generateDaoImplMethod() {
		...
		list.add(NamedS2SHStatementGenerator.getDeleteHibernateHqlStatement(1000L,2, this.domain,InterVarUtil.Hibernate.hql));
		list.add(NamedS2SHStatementGenerator.getExecutiveHqlStatement(2000L,2,this.domain,InterVarUtil.Hibernate.hql));
